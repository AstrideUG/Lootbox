...
public class SpiralAnimation extends AnimatedParticleEffect {
    ...
    public SpiralAnimation(final Location location, final EnumParticle particle, final double radius,
