...
public class DoubleCircleParticleEffect extends ParticleEffect {
    ...
    public DoubleCircleParticleEffect(final Location location, final double radius, final EnumParticle particle) {
        this.radius = radius;
